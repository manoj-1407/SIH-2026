...
<div class="cert-page">
  ...
  <div class="section">
    <div class="section-title">Legal Compliance &amp; Standards</div>
    {_html_kv([
        ('BSA 2023 §63(4)', 'Bharatiya Sakshya Adhiniyam 2023 — Electronic evidence admissibility framework'),
        ('Attestation Component', 'Technical Expert Attestation (Part B) — cryptographic integrity verification'),
        ('IT Act 2000 §65B', 'Information Technology Act — electronic records as evidence in Indian courts'),
        ('NIST SP 800-88 Rev. 2', 'Media Sanitization Guidelines — Clear / Purge / Destroy'),
        ('IEEE 2883-2022', 'Storage Device Sanitization — extends NIST to NVMe, SSD, flash media'),
        ('RFC 8785 (JCS)', 'JSON Canonicalization Scheme — deterministic serialization before signing'),
        ('RFC 8032', 'Edwards-Curve Digital Signature Algorithm (Ed25519)'),
    ])}
    <div style="margin-top:12px;padding:10px 14px;background:#f8f8fc;border-left:4px solid #ca8a04;border-radius:4px;font-size:11px;color:#555;line-height:1.6;">
      <strong>BSA 2023 §63(4) Compliance Note:</strong> This certificate constitutes the technical expert
      attestation component under the Bharatiya Sakshya Adhiniyam 2023 framework. The Ed25519 digital
      signature and SHA-256 evidence hash provide the cryptographic binding required for electronic
      evidence admissibility. The Investigating Officer attestation (Part A) should be obtained separately
      and cross-referenced with this certificate's Evidence ID for complete dual-party compliance.
    </div>
  </div>
  ...
  <div class="cert-footer">
    ...
    Compliant with Bharatiya Sakshya Adhiniyam 2023 §63(4) and IT Act 2000 §65B.<br>
    Verify offline: <code>python scripts/verify_certificate.py {ev_id}</code> or <code>node scripts/verify_evidence.js</code><br>
    Chain-of-custody audit log: <code>data/audit/{case_id}.jsonl</code> — independently verifiable via <code>node scripts/verify_chain.js</code><br>
...
def generate_pdf_certificate(
    ...
    try:
        ...
        rows_data = [
            ...
            ('BSA 2023 §63(4):', 'Technical Expert Attestation (Part B)'),
            ('IT Act 2000 §65B:', 'Electronic evidence compliance'),
